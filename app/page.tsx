...
export default function BrowserRuntimeDocs() {
  ...
  const slides = [
    ...
    { id: "mfe-intro", title: "Microfrontends Intro", content: <MFEIntroSection /> },
    { id: "mfe-patterns", title: "MFE Patterns", content: <MFEPatternsSection /> },
    { id: "mfe-deep-dive", title: "MFE Deep Dive", content: <MFEDeepDiveSection /> },
    { id: "mfe-problems", title: "The MFE Tax", content: <MFEProblemsSection /> },
    { id: "mfe-integration", title: "Integration Runtime", content: <MFEIntegrationSection /> },
    { id: "module-federation", title: "Module Federation", content: <ModuleFederationSection /> },
    { id: "challenge-2", title: "Debug Challenge #2", content: <ChallengeTwoSection /> },
  ]
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <main>
        ...
        <div className="border-t-4 border-accent/30 bg-gradient-to-b from-accent/5 to-transparent">
          ...
          <div className="border-t border-border/50" ref={sectionRefs["mfe-patterns"]}>
            <MFEPatternsSection />
          </div>
          ...
          <div className="border-t border-border/50" ref={sectionRefs["mfe-integration"]}>
