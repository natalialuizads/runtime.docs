  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16">
      <div className="mb-12">
        ...
        <h2 className="text-4xl font-bold text-foreground">Vertical vs Horizontal Splits</h2>
        <p className="mt-4 text-xl text-muted-foreground leading-relaxed">
          Essa é uma distinção fundamental. Entender onde cortar o bolo define qual estratégia técnica você deve escolher.
        </p>
      </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <h4 className="flex items-center gap-2 font-bold text-primary mb-3">
                ...
                Vertical Split (Rota/Jornada)
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                O usuário carrega uma aplicação por vez. O MFE toma conta da tela inteira (exceto talvez o Shell).
              </p>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-xs font-mono text-muted-foreground italic">
                  <Star className="h-3 w-3 text-yellow-500" /> CASO SPOTIFY: "Sua Biblioteca" vs "Home"
                </div>
              </div>
            </div>
            <div>
              <h4 className="flex items-center gap-2 font-bold text-accent mb-3">
                ...
                Horizontal Split (Fragmento/Widget)
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                O usuário vê vários MFEs ao mesmo tempo na mesma tela. Composição granular.
              </p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-xs font-mono text-muted-foreground">
                ...
                <div className="flex items-center gap-2 text-xs font-mono text-muted-foreground italic">
                  <Star className="h-3 w-3 text-yellow-500" /> CASO SPOTIFY: Barra de Play + Sidebar de Amigos
                </div>
              </div>
            </div>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-muted/50 border-b border-border">
                ...
                <th className="p-4 font-mono text-xs uppercase tracking-wider text-center">Vertical Split</th>
                <th className="p-4 font-mono text-xs uppercase tracking-wider text-center">Horizontal Split</th>
                <th className="p-4 font-mono text-xs uppercase tracking-wider">Veredito</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              <tr>
                ...
                <td className="p-4 text-center"><Star className="inline h-4 w-4 text-yellow-500 fill-yellow-500" /> Excelente</td>
                <td className="p-4 text-xs text-muted-foreground">O único que faz os dois com alta performance (compartilhando dependências).</td>
              </tr>
              <tr>
                <td className="p-4 font-bold text-sm">Server-Side Comp.</td>
                <td className="p-4 text-center text-yellow-500 text-sm">🟡 Bom (via Link)</td>
                <td className="p-4 text-center"><Star className="inline h-4 w-4 text-yellow-500 fill-yellow-500" /> Excelente</td>
                <td className="p-4 text-xs text-muted-foreground">Rei do Horizontal. Monta Header+Footer+Body no servidor.</td>
              </tr>
              <tr>
                <td className="p-4 font-bold text-sm">Edge-Side Comp.</td>
                <td className="p-4 text-center text-yellow-500 text-sm">🟡 Bom (via Rota)</td>
                <td className="p-4 text-center"><Star className="inline h-4 w-4 text-yellow-500 fill-yellow-500" /> Excelente</td>
                <td className="p-4 text-xs text-muted-foreground">Incrível para Horizontal. Monta a página na CDN.</td>
              </tr>
              <tr>
                ...
                <td className="p-4 text-xs text-muted-foreground">Ótimo para "folhas" da árvore (botões, cards, widgets isolados).</td>
              </tr>
              <tr>
                ...
                <td className="p-4 text-xs text-muted-foreground">Usado pela Spotify no Desktop antigo para isolar Squads.</td>
              </tr>
              <tr>
                <td className="p-4 font-bold text-sm">Build-Time</td>
                <td className="p-4 text-center"><XCircle className="inline h-4 w-4 text-red-500" /> Ruim</td>
                <td className="p-4 text-center text-yellow-500 text-sm">🟡 Possível</td>
                <td className="p-4 text-xs text-muted-foreground">Cria um monolito. Evite.</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="mb-20 space-y-12">
        <h3 className="text-2xl font-bold text-foreground flex items-center gap-3">
          ...
          3. Análise Detalhada (O "Como fazer")
        </h3>

        <div className="grid gap-8">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-8">
            <h4 className="text-xl font-bold mb-4 flex items-center gap-2">
              <span className="text-primary">A.</span> Onde aplicar Horizontal Split
            </h4>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-4">
                <div className="flex items-center gap-2 font-bold text-sm border-b border-border pb-2">
                  <Star className="h-4 w-4 text-yellow-500" /> Spotify Case
                </div>
              ...
              <div className="space-y-2">
                <div className="font-bold text-sm">Tip: Module Federation (Client)</div>
                <p className="text-xs text-muted-foreground italic">Use CSS Skeleton para evitar "Layout Shift" quando o widget carregar.</p>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-8">
            <h4 className="text-xl font-bold mb-4 flex items-center gap-2">
              <span className="text-primary">B.</span> Onde aplicar Vertical Split
            </h4>
            <p className="text-muted-foreground mb-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <div className="space-y-4">
                <div className="flex items-center gap-2 font-bold text-sm border-b border-border pb-2 text-primary">
                  <AppWindow className="h-4 w-4" /> Exemplo: Checkout Flow
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-xs">Usa **Router** para mudar de `/cart` para `/payment`.</div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-6 w-6 shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-[10px] font-bold">2</div>
                    <div className="text-xs">O **Shell** mantém apenas o Header global.</div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-6 w-6 shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-[10px] font-bold">3</div>
                    <div className="text-xs">O MFE de Checkout carrega seu próprio CSS/JS isolado.</div>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-2 font-bold text-sm border-b border-border pb-2 text-yellow-500">
                  <Star className="h-4 w-4" /> Spotify Case
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  A página de **Artistas** e a página de **Configurações** são jornadas verticais. A Shell orquestra a troca dessas "Mini-Apps".
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Usamos o split vertical para separar as Jornadas (A e B). Cada jornada é um MFE carregado sob demanda via Rota.</p>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Dentro das jornadas, usamos split horizontal para funcionalidades transversais.</p>
                <div className="mt-2 space-y-1">
                  <div className="text-[10px] font-mono text-muted-foreground flex items-center gap-1 italic">
                    <CheckCircle2 className="h-3 w-3 text-accent" /> Shared Libs: Formulário de Cadastro carregado em A e B.
                  </div>
                  <div className="text-[10px] font-mono text-muted-foreground flex items-center gap-1 italic">
                    <CheckCircle2 className="h-3 w-3 text-accent" /> Composition: Shell fixo (Header/Menu) compondo com a Jornada.
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-6 border-l-4 border-l-primary">
          ...
          <p className="text-sm text-muted-foreground">Para separar Times e Jornadas de Negócio (Baseado em Router).</p>
        </div>
        <div className="rounded-xl border border-border bg-card p-6 border-l-4 border-l-accent">
          ...
          <p className="text-sm text-muted-foreground">Para separar Componentes Reutilizáveis na mesma tela (Baseado em Composition).</p>
        </div>
      </div>
