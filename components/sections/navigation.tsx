...
const sections = [
  ...
  { id: "mfe-communication", label: "Comunicação", icon: Link2 },
  { id: "mfe-integration", label: "Integração", icon: Boxes },
  { id: "composition-strategies", label: "Composição", icon: Layout },
  ...
  { id: "server-driven-ui", label: "SDUI", icon: Package },
