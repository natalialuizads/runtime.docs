      ...
      <div className="rounded-xl border border-border bg-card p-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">
            Cada squad e dona de um pedaco vertical da UI + API + Database. E
            como ter microservicos com ownership claro.
          </p>
        </div>
        ...
        <div className="mb-6 overflow-x-auto rounded-lg border border-border bg-background">
          {/* Top Bar */}
          <div className="flex items-center justify-between border-b border-border bg-secondary/50 px-4 py-2 min-w-fit">
            <div className="flex items-center gap-4">
              <Music className="h-6 w-6 text-accent shrink-0" />
              <div
                className={cn(
            ...
            <div
              className={cn(
                "flex items-center gap-2 rounded-full bg-secondary px-3 py-1 ml-4",
          ...
          <div className="flex min-w-fit">
            {/* Sidebar */}
            <div className="w-40 sm:w-48 border-r border-border bg-secondary/30 p-4 shrink-0">
                ...
                {[
                  ...
                  return (
                    <button
                      key={item.id}
                      className={cn(
                        "flex w-full items-center gap-3 rounded-md px-3 py-2 text-xs sm:text-sm transition-all",
              ...
              <div className="mt-6 border-t border-border pt-4">
                ...
                >
                  ...
                  <div className="space-y-1">
                    {["Liked Songs", "Discover Weekly", "My Playlist #1"].map(
                      (pl) => (
                        <div
                          key={pl}
            ...
            {/* Main Content */}
            <div className="flex-1 p-4 min-w-96">
              <div
                className={cn(
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
                  {[
                    ...
                    >
                      <div className="h-10 w-10 rounded bg-gradient-to-br from-primary/50 to-accent/50 shrink-0" />
          ...
          <div
            className={cn(
              "flex items-center justify-between border-t border-border bg-secondary/50 px-4 py-3 transition-all min-w-fit",
          ...
          >
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded bg-gradient-to-br from-accent to-primary shrink-0" />
              ...
              <Heart className="h-4 w-4 text-muted-foreground ml-2 sm:ml-0" />
            </div>
            <div className="flex items-center gap-4">
        ...
        {selected && (
          <div
            className={`rounded-lg border border-${selected.color}/30 bg-${selected.color}/5 p-4 mx-auto max-w-5xl`}
          >
            <div className="mb-4 flex items-center gap-3">
              <selected.icon
                className={`h-6 w-6 text-${selected.color} shrink-0`}
              />
              <div>
        ...
        <div className="mt-6 rounded-lg bg-secondary/30 p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Cada Squad e um <strong>Bounded Context</strong>. Eles tem ownership
            completo: UI + API + Database + Deploy Pipeline. Comunicacao entre
            Squads acontece via contratos (APIs) e eventos, nunca acesso direto
            ao banco do outro.
          </p>
